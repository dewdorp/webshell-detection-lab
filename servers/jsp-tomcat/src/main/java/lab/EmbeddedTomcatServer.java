...
public class EmbeddedTomcatServer {
    public static void main(String[] args) throws Exception {
        ...
        String host = System.getProperty("lab.host", System.getenv().getOrDefault("LAB_HOST", "0.0.0.0"));
        ...
        tomcat.start();
        System.out.printf("JSP/Tomcat lab server listening on http://%s:%d%n", host, port);
